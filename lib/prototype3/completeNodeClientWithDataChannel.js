...
var locaVideo = document.querySelector('#localVideo');
...
// Start: prompt user for input (room name)
...
function createPeerConnection() {
    ...
    if(isInitiator) {
        ...
        // Joiner
        pc.ondatechannel = gotReceiveChannel;
    }
}
...
function handleReceiveChannelStateChange() {
    ...
    trace('Receice channel state is: ' + readyState);
...
function handleRemoteStreamRemoved(event) {
    console.log('Remote stream remove. Event: ', event);
}
